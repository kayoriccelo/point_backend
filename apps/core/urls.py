...
from apps.user_custom.viewsets import UserAllowAnyViewSet, UserCustomViewSet, UserProfileViewSet
...
router.register(r'userallowany', UserAllowAnyViewSet, base_name='user')
router.register(r'user', UserCustomViewSet, base_name='usertoken')
router.register(r'profile', UserProfileViewSet, base_name='usertoken')
