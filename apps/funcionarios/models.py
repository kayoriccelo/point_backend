...
class Funcionario(models.Model):
    ...
    user = models.OneToOneField(Usuario, verbose_name=_("usuario"), null=True, related_name='funcionario',
                                on_delete=models.CASCADE)
    jornada = models.ForeignKey('jornadas.Jornada', verbose_name=_('jornada'), null=True, related_name='funcionario',
                                on_delete=models.DO_NOTHING)
    empresa = models.ForeignKey('empresa.Empresa', verbose_name=_('empresa'), null=True, related_name='funcionario',
                                on_delete=models.CASCADE)
